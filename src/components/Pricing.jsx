            ...
            >
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <div className="flex items-baseline justify-center">
                  ...
                  <span className="text-gray-400 ml-1 sm:ml-2 text-sm sm:text-xl">
                    /month
                  </span>
                </div>
              </div>
              ...
              <button
                className={`w-full py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg font-semibold transition-all duration-300 mt-auto hover:scale-102 cursor-pointer text-sm sm:text-xl ${
                  plan.mostPopular
